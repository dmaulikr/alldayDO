...
//! Project version number for alldayDOKit.
FOUNDATION_EXPORT double alldayDOKitVersionNumber;

//! Project version string for alldayDOKit.
FOUNDATION_EXPORT const unsigned char alldayDOKitVersionString[];
